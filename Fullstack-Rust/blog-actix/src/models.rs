...
pub fn get_post_comments(conn: &SqliteConnection, post_id: i32) -> Result<Vec<(Comment, User)>> {
    comments::table
...
pub fn all_posts_with_comments(conn: &SqliteConnection) -> Result<Vec<((Post, User), Comments)>> {
